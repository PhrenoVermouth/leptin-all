...
wilcox.test(fat_normat[,5],fat_normat[,10],paired = TRUE) #W4~W48 wilcox=0.035,0.023,0.489,0.890,0.003
wilcox.test(inflam_normat[,4],inflam_normat[,9],paired = TRUE) #W4~W48  wilcox=0.223,0.235,0.086,0.219,0.001
